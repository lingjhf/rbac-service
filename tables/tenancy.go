...
type Tenancy struct {
	Base
	Name     string   `gorm:"type:varchar(32);not null;uniqueIndex:idx_name_owner;"`
	Owner    string   `gorm:"type:varchar(36);not null;uniqueIndex:idx_name_owner;"`
	ParentId *string  `gorm:"varchar(36);uniqueIndex:idx_name_owner;"`
